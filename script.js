...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ===== Portfolio Section Interactions (updated) =====
    function setupPortfolioInteractions() {
        // Add hover effect for portfolio cards (already handled by CSS, but we keep for any additional JS)
        ...
        // Optional: track clicks on "Visit Project" buttons
        const portfolioBtns = document.querySelectorAll('.portfolio-btn');
        portfolioBtns.forEach(btn => {
            btn.addEventListener('click', function(e) {
                console.log('Visit Project clicked:', this.href);
